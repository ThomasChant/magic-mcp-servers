...
const About: React.FC = () => {
    ...
    return (
        <div className="bg-gray-50">
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center bg-blue-50 rounded-xl p-8 hover:transform hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="text-center bg-green-50 rounded-xl p-8 hover:transform hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="text-center bg-purple-50 rounded-xl p-8 hover:transform hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Team Member 1 */}
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center hover:transform hover:-translate-y-2 transition-all duration-300">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8" ref={statsRef}>
                        <div className="text-center">
                            <div className="stats-number text-4xl font-bold text-blue-600 mb-2">
                                200+
                            </div>
                            <div className="text-gray-600">MCP Servers</div>
                        </div>
                        <div className="text-center">
                            <div className="stats-number text-4xl font-bold text-green-600 mb-2">
                                50K+
                            </div>
                            <div className="text-gray-600">Monthly Downloads</div>
                        </div>
                        <div className="text-center">
                            <div className="stats-number text-4xl font-bold text-purple-600 mb-2">
                                10K+
                            </div>
                            <div className="text-gray-600">Active Developers</div>
                        </div>
                        <div className="text-center">
                            <div className="stats-number text-4xl font-bold text-orange-600 mb-2">
                                25
                            </div>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">hello@mcphub.dev</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">Community chat</p>
                            </div>

                            <div className="text-center">
                                <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                                    <Github className="text-gray-600 w-6 h-6" />
                                </div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                                    Contribute
                                </h3>
